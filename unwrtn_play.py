...
for row in reader:
    if reader.line_num == 1:
        ...
        html = html + '<dl><strong><a href="https://d2uzw09ppuvr94.cloudfront.net/title/'+crow['Const']+'" alt="flexi TV-R">'+crow['Title']+'</a></strong><a> </a><a href="http://www.imdb.com/title/'+crow['Const']+'"alt="IMDb">'+crow['Year']+'</a><a> </a><a href="http://www.imdb.com/list/ls064891288/?sort=alpha,asc&st_dt=&mode=grid&page=1&ref_=ttls_vw_grd"alt="Genres"> '+crow['Genres']+'</a><a> </a><a href="http://www.imdb.com/title/'+crow['Const']+'/externalreviews?ref_=tturv_ql_5'+'"alt="Reviews">read reviews</a></dl>'
        f = open('flexi.html','w')
f.write(html)
f.close()
